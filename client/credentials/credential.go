...
func (cc *CredsClient) RequestToken() error {
	...
	// err = io.WriteFile("prover/credentials/"+cc.CredName+".json", s, 0644)
	// if err != nil {
	// log.Println("io.WriteFile error:", err)
	// return err
	// }
...
func (cc *CredsClient) SetOrder() error {
	...
	err = os.WriteFile("prover/credentials/"+cc.CredName+".json", s, 0644)
	if err != nil {
